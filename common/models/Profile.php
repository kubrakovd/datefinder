...
class Profile extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [[ 'firstname', 'lastname', 'birthdate', 'country_id', 'region_id', 'city_id', 'gender', 'want_find', 'phone', 'purpose', 'height', 'weight', 'body', 'appearance', 'education', 'languages', 'has_children', 'orientation', 'smoking', 'alcohol', 'habitation', 'interests', 'relationships', 'religion'], 'required'],
